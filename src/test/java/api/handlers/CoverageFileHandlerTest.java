...
public class CoverageFileHandlerTest {
    ...
    public void testHandleWithValidFile() throws IOException, URISyntaxException {
        ...
        verify(mockHttpExchange, times(1)).sendResponseHeaders(statusCodeCaptor.capture(), contentLengthCaptor.capture());
    ...
    public void testHandleWithInvalidFile() throws IOException, URISyntaxException {
        ...
        // Validate
        verify(mockHttpExchange, times(1)).sendResponseHeaders(INTERNAL_SERVER_ERROR, "Internal Server Error".length());
    }
}